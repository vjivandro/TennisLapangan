...
/**
 * Created by vjivandro on 9/18/17.
 */

public class TestPerwasitan extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_wasit);
        ...
        listTestParser = new ArrayList<TestParser>();
        listTestParser = db.getSoalWasit();
    ...
    private void setUpWaktu() {
        mCountDownTimer = new TestPerwasitan.CounterClass(detik, 1000);
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            String pertanyaan = testParser.getSoalWasit();
            ...
            rg.check(-1);
            String jwb_a = testParser.getPil_a();
            rdA.setText(jwb_a.toCharArray(), 0,
                    jwb_a.length());
            String jwb_b = testParser.getPil_b();
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(TestPerwasitan.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            TestPerwasitan.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
